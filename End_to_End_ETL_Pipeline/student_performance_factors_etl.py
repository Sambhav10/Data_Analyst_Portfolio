...
glue_client = boto3.client('glue', region_name=regionName)
...
with DAG('srudent_performance_factors_etl',
        default_args=default_args,
        schedule_interval = '@weekly',
        catchup=False) as dag:

        glue_job_trigger = PythonOperator(
        task_id='task_glue_job_trigger',
        ...
        task_id="task_is_glue_job_finish_running",      
        job_name='s3_upload_to_redshift_gluejob',
